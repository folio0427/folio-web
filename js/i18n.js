...
(() => {
  ...
  const dict = {
    zh: {
      ...
      'modes.pure.h':          '來這裡，是為了找人一起讀書',
      'modes.pure.tagline':    '「來這裡交朋友，就只是交朋友。」',
      'modes.pure.desc':       '只想找人共讀、交換心得，不發展任何浪漫可能。乾淨、安靜、有書就好。',
      'modes.romance.badge':   '純粹找緣分',
      'modes.romance.h':       '來這裡，是想從書裡認識一個人',
      ...
      'flow.step3.h':          '共讀',
      'flow.step3.p':          '配對成立、共讀室開啟。雙方各自推到 25% 並寫下心得、聊天才解鎖。解鎖後可自由對話、收藏對方寫過的句子。',
      'flow.step4.h':          '整理',
      'flow.step4.p':          '各自讀到 100%、便利貼整理成一張閱讀紀念。可分享到 IG、Threads、X — 是你與這本書的關係證明。',
      'flow.details.h':        '設計上的小事',
      'flow.detail1.h':        '一天最多兩篇',
      'flow.detail1.p':        '避免洗版、避免被看成「廣告」。每 24 小時兩篇是上限，刪了也不會還你次數 — 想清楚再發。',
      'flow.detail2.h':        '共讀便利貼牆',
      'flow.detail2.p':        '每對共讀都有一面便利貼牆 — 雙方寫下的 25% / 100% 心得會貼在一起，按時間排序，是只屬於你們的紀念。',
      ...
      'solo.note':             '你寫過的字、收藏的句子，永遠是你的 — 不會因為沒人配對就消失。',
    ...
    en: {
      ...
      'flow.kicker':           '— How it works —',
      'flow.title':            'Reading is the process. Connection is the result.',
      ...
      'flow.step4.p':          'When both reach 100%, the notes compile into a reading memento. Shareable to IG, Threads, X — proof of your bond with this book.',
      ...
      'flow.detail2.p':        'Every co-reading has its own wall — 25% and 100% reflections from both sides, in time order, belonging only to the two of you.',
      ...
      'solo.note':             'The words you\'ve written and saved are always yours — they don\'t disappear if no one matches.',
