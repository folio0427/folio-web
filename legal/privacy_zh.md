...
> **版本** v1.7 ｜ **生效日** 2026-08-21 ｜ **最後更新** 2026-08-21 ｜ **狀態** 正式
...
- 本平台以此類資料**提供配對服務**：「抱持心態」用於配對過濾矩陣（決定誰能互相看到）；「想找的性別」僅作為對符合條件之對方顯示的偏好訊號、**本身不用於篩選**您看到的對象。此類資料**不**販售、**不**用於廣告投放、**不**用於建立廣告 / 行銷剖繪（profiling）。分析服務（Firebase）**不接收**您的心態、性別或想找的性別 —— 僅收到年齡與去識別化的使用流程事件，故「性傾向」之推斷**從不進入**分析或廣告。
...
- 漂流瓶：他人收藏您信件之副本、保留於該收藏者之信匣直至其刪除；您婉拒之回信與對話、以及因過期或管理處置而下架之內容、會移入封存區保留（供濫用防制、營運統計與法律抗辯之目的）、不再對一般用戶顯示
...
- 您跟對方在共讀室裡的訊息
- 您在他人書房訪客簿留下的留言
- 已成立筆友關係之漂流瓶通信（對方端轉為唯讀紀念；他人已收藏之您的信件副本仍保留於其信匣；尚未成立筆友關係之回信與投遞則直接刪除）
- 顯示時作者名稱替換為「已離開的書友」
