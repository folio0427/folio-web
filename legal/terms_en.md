...
- Downloading, registering, or using Folio constitutes acceptance
- If you do not agree, do not use the service
- These Terms form a legally binding contract between you and the developer

## 02　Nature of Service

- Folio is a book-centered social platform that matches users via shared reading
- Three modes: Pure Book Friend / Open to Connection / Open
- Not a matrimonial agency, dating bureau, or matching guarantor
- We do not verify users' marital status, profession, education, finances, or health

## 03　Age Restriction (18+)

- Service is restricted to natural persons aged 18 or older
...
### Personal harm prohibited

- Harassment, stalking, bullying, threats, doxxing
- Sexual harassment, sexual coercion, non-consensual intimate content
...
- Identity impersonation, fabrication
- Romance fraud, financial fraud, pyramid schemes
- Unauthorized commercial promotion

### Technical abuse prohibited

- Bots, scrapers, exploits, attacks on the system
...
- By tapping share to IG / Threads / X, you confirm right to share
- You acknowledge content carries Folio watermark
- External sharing legal liability is yours

## 07　Book Citations & Copyright

- Book titles, reflections, discussions are your commentary, not the book's text
- Substantial copying, reproduction, or upload of book text is prohibited
- Fair use evaluated under Taiwan Copyright Act §52, §65
- Copyright holders may notify us at folio0427@gmail.com
...
- We are not liable for any damages arising from matching, meetings, relationships
- Including bodily injury, sexual assault, financial loss, emotional dispute, defamation, fraud

## 09　Privacy

- Personal data handling detailed in our **Privacy Policy**
...
- We may add, modify, suspend, or terminate features at any time
- Service may be interrupted during maintenance
- Not liable for losses due to service changes
...
> **Contact & Disputes**
> Service currently provided by an independent developer (no company yet).
> All terms-related questions, complaints, copyright notices, data requests:
